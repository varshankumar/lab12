...
public class FamilyTree
{
	...
	private static class TreeNode
	{
		...
		TreeNode getNodeWithName(String targetName)
		{
			...
			for (TreeNode child: children)
			{
				...
				TreeNode potentialTarget = child.getNodeWithName(targetName);
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) throw new TreeException("There is no colon in this line.");
		...
		else
		{
			...
			if(parentNode == null) throw new TreeException("There is no parent node.");
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Unable to find a node with name1.");
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException("Unable to find a node with name2.");
